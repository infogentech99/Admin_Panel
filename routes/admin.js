...
// // //   console.log("POST /admin/create-user called"); // Debugging log
...
// //   console.log("PUT /admin/update-user called with id:", req.params.id); // Debugging log
// //   try {
// //     const { id } = req.params;
...
// //   console.log("DELETE /admin/delete-user called with id:", req.params.id); // Debugging log
// //   try {
// //     const { id } = req.params;
...
// // ✅ Create a new user
// router.post("/create-user", async (req, res) => {
//   console.log("POST /admin/create-user called");
//   try {
//     const { username, password, email, contact, role, status } = req.body;
//     if (!username || !password || !email || !contact || !role || !status) {
//       return res.status(400).json({ message: "All fields are required!" });
